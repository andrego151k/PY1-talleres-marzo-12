#  punto 2 tarifas para cada región
tarifa_eeuu = 900
tarifa_canada = 800
tarifa_europa = 950
tarifa_resto_mundo = 1250

#  duración para aplicar 20% menos
umbral_descuento = 15


def operacion_costo(tarifa, duracion):
    costo_total = tarifa * duracion

    # Aplicar 20% desc si dura mayor al umbral
...
while True:
    ...
    if opcion == '5':
        ...
        # input duracion para determinar si desc
        duracion = int(input("pon la duración, 20% off si es mas de 15 : "))

        # condional de cada region
        if opcion == '1':
            tarifa = tarifa_eeuu
        elif opcion == '2':
        ...
        # costo total punto 3
        costo_total = operacion_costo(tarifa, duracion)
